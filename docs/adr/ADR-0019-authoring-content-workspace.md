...
**A backend for the game** was never on the table: ADR-0009's "no application
server" is what makes the delivery a folder of static files, and ADR-0017 what
...
(ADR-0015). The game reads content as static files, exactly as the delivered
executable does.
...
- the runtime is untouched: no build of the game talks to this server, and
  ADR-0009's invariant holds as written;
