# ADR-0024 — The Client Opens on an Authored Title Screen
...
has just launched. ADR-0018 fixed *what* the client ships; it said nothing about
...
- `continue` is permanently disabled until saves exist (ADR-0010), so the button
