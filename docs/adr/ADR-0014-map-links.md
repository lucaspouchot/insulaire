...
rejected for now because the scenario runtime (ADR-0004) does not exist yet, and
...
ADR-0001 and ADR-0010 exist to prevent.
...
to 6 still run before the swap, so the pipeline order of ADR-0003 is unchanged
