...
ADR-0009 chose a static web bundle and wrote down its own risk: *"opening
...
renderer and the interface, which is exactly the drift ADR-0015 refused for the
editor.
...
still the editor-free bundle ADR-0015 defines, produced by the same file
replacement.
